...
if __name__ == '__main__':
    train_dataset = Cub2011('/project/data/external/CUB/cub2011', train=True, download=True)
    test_dataset = Cub2011('/project/data/external/CUB/cub2011', train=False, download=True)
